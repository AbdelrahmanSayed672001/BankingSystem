...
<!-- Contact Us -->
    <section id="next" class="site-section bg-light" id="contact-section" data-aos="fade">
      <div class="container">
        <div class="row mb-5">
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4 text-center">
            <p class="mb-4">
              ...
              <a href="../assets/cssHomePage/#">+1 232 3235 324</a>
            </p>
          </div>
          <div class="col-md-4 text-center">
            <p class="mb-0">
              <span class="icon-mail_outline d-block h2 text-primary"></span>
              <a href="../assets/cssHomePage/#">youremail@domain.com</a>
            </p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 mb-5">
            ...
            <form method="get" action="../Controller/Contacts.php" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="text" id="FullName" name="FullName" class="form-control" value="<?= $_SESSION["FullName"]?>">
                  <!-- <input type="hidden" id="ID" name="UserID" class="form-control" value="<?= $_SESSION["ID"]?>"> -->
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input style="background: #FFC312;color:black;border-color: black;" type="submit" value="Send Message" class="btn btn-primary btn-md text-white">
                </div>
              </div>
