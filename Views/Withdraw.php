...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <!-- Withdraw form -->
    <div id="next" class="containerWithdraw">
        <div class="title">
            <strong>
                <h1>Withdraw money</h1>
            </strong>
        </div>
        <form method="post" action="../Controller/Withdraw.php">
            ...
            <div style="text-align: center;margin-left: 9px;" >
                ...
                <input type="number" name="WithdrawValue" placeholder="your balance is <?= $_SESSION["Balance"]?>" required="">
            </div>
