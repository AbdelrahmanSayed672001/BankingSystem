...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <!-- Tranfer money -->
    <div id="next" class="containerTranfer">
        <div class="title">
            <strong>
                <h1>Tranfer money</h1>
            </strong>
        </div>
        <form method="post" action="../Controller/Transfer.php">
            <div style="text-align: center;">
                <label for="BankID">From</label>
                <input type="text" id="fname" name="BankID" value="<?= $_SESSION["BankID"]?>" required="">
            </div>
            <div style="text-align: center;margin-left: 20px;">
                <label for="BankID">To</label>
                <input type="text" id="fname" name="TO" placeholder="Receiver BankID" required="">
            </div>
            <div style="text-align: center;margin-left: -5px;" >
                <label for="Value">Value</label>
                <input type="number" id="lname" name="Value" placeholder="Value" required="">
            </div>
